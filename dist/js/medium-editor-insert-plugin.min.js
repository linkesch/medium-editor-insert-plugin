...
d&&d(this.$el.find(".medium-insert-image-active")),this.getCore().hideButtons(),this.$el.trigger("input")},d.prototype.sorting=function(){this.options.sorting()},a.fn[e+f]=function(b){return this.each(function(){a.data(this,"plugin_"+e+f)||a.data(this,"plugin_"+e+f,new d(this,b))})}}(jQuery,window,document);