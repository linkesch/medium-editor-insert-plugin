  ...
  grunt.initConfig({
    ...
    uglify: {
      build: {
        ...
        src: ['src/js/medium-editor-insert-plugin.js', 'src/js/medium-editor-insert-images.js', 'src/js/medium-editor-insert-maps.js', 'src/js/medium-editor-insert-videos.js'],
      ...
      f4: {
        ...
        src: 'src/js/medium-editor-insert-videos.js',
        dest: 'dist/js/addons/medium-editor-insert-videos.min.js'
      }
    },
